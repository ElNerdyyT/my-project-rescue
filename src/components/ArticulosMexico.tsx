  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const { data: supabaseData, error, count } = await query.range(
    ...
    fetchData();
  }, [currentPage, searchQuery, selectedSucursal]);
    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-4 sm:px-6 py-4 border-b border-gray-100 flex flex-col sm:flex-row gap-3 items-start sm:items-center">
          <h2 class="text-lg font-semibold text-gray-800">Artículos</h2>
