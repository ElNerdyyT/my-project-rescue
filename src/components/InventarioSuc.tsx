...
const InventarioSuc = () => {
    ...
    const generarReportePDF = () => {
        ...
        try {
            ...
            // 1. Filtrar los artículos según el departamento y subdepartamento seleccionado EN PANTALLA.
            ...
            // 2. De esa lista YA FILTRADA, tomar solo los que tienen conteo físico o diferencias.
